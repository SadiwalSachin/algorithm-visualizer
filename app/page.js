...
export default function Home() {
  return (
    <div className="h-screen flex flex-col items-center bg-zinc-900 border-none">
      <div className="px-4 py-10 md:py-20">
        <h1 className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold text-slate-700 md:text-4xl lg:text-7xl dark:text-slate-300">
          {"Master DSA Visually – One Algorithm at a Time"
            .split(" ")
            .map((word, index) => (
              <motion.span
                key={index}
        ...
        >
          Explore how sorting and searching algorithms work through engaging, step-by-step visualizations. Start with arrays – the foundation of DSA.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
