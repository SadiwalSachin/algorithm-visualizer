...
export default function InsertNodeVisualizer() {
  const svgRef = useRef();
  ...
  const insertNode = async () => {
    ...
    if (!inputValue.trim() || isNaN(pos) || pos < 0 || pos > nodes.length) return;
  ...
  return (
    <div className="min-h-screen bg-zinc-900 text-white py-8 px-4 md:px-8">
      ...
      <h1 className="text-2xl font-bold mb-4">Insert Node in Linked List</h1>
